...
for i, group in enumerate(groups):
    ...
    fig_L.savefig(f'/data/p_02915/dhcp_derivatives_SPOT/Figures_v2/{group}_L_polarangle.pdf')
    fig_R.savefig(f'/data/p_02915/dhcp_derivatives_SPOT/Figures_v2/{group}_R_polarangle.pdf')