...
for param in parameters:
    ...
    for idx, (groupA_name, groupB_name) in enumerate(group_pairs):        
        ...
        file_L = f'/data/p_02915/dhcp_derivatives_SPOT/statistics/{groupA_name}_{groupB_name}_L_{param}_vertexwise.shape.gii'
        file_R = f'/data/p_02915/dhcp_derivatives_SPOT/statistics/{groupA_name}_{groupB_name}_R_{param}_vertexwise.shape.gii'
    ...
    plt.tight_layout()
    plt.savefig(f'/data/p_02915/dhcp_derivatives_SPOT/Figures_v3/Figure_{param}_comparison_combat_v2.png', dpi=600)
    print(param)
    #plt.show()