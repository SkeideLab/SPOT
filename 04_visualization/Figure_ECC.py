...
for i, group in enumerate(groups):
    ...
    hist_R_pos = [0.60, 1 - i*0.15, 0.12, 0.1]
...
cbar = plt.colorbar(cm.ScalarMappable(cmap='jet', norm=plt.Normalize(
    vmin=0, vmax=20)), cax=cbar_ax, orientation='horizontal', fraction=.1)
cbar.set_label('Eccentricity')

# Save the figure
fig.savefig("/data/p_02915/dhcp_derivatives_SPOT/Figures_v2/ECC_all.png",
