...
for i, group in enumerate(groups):
    ...
    hist_R_pos = [0.63, 1 - i*0.13, 0.12, 0.1]
    ...
    ax_hist_L.set_ylim(0, 0.06)
    ax_hist_L.set_xlabel("Polar angle" if i == 6 else "", labelpad=1)
    ax_hist_L.set_ylabel("Probability\ndensity" if i == 6 else "",)
    ax_hist_L.set_xticks([0, 90, 180])

    sns.histplot(data=data_R, x='ecc', ax=ax_hist_R,
                 color=colors[group], bins=bin, stat='density')
    ax_hist_R.set_xlim(0, 180)
    ax_hist_R.set_ylim(0, 0.06)
    ax_hist_R.set_xlabel("Polar angle" if i == 6 else "", labelpad=1)
    ax_hist_R.set_ylabel("Probability\ndensity" if i == 6 else "",)
    ax_hist_R.set_xticks([0, 90, 180])

    if group == "preterm":
        average_left = f"/data/p_02915/dhcp_derivatives_SPOT/Neonates/ccfmodel/Averaged_younger_n_L_label-polarangle_desc-real_roi-v2th00_metric.gii"
        average_right = f"/data/p_02915/dhcp_derivatives_SPOT/Neonates/ccfmodel/Averaged_younger_n_R_label-polarangle_desc-real_roi-v2th00_metric.gii"
    elif group == "fullterm":
        average_left = f"/data/p_02915/dhcp_derivatives_SPOT/Neonates/ccfmodel/Averaged_older_n_L_label-polarangle_desc-real_roi-v2th00_metric.gii"
        average_right = f"/data/p_02915/dhcp_derivatives_SPOT/Neonates/ccfmodel/Averaged_older_n_R_label-polarangle_desc-real_roi-v2th00_metric.gii"
    elif group == "2nd":
        average_left = f"/data/p_02915/dhcp_derivatives_SPOT/fetal/ccfmodel/Averaged_younger_fetal_L_label-polarangle_desc-real_roi-v2th00_metric.gii"
        average_right = f"/data/p_02915/dhcp_derivatives_SPOT/fetal/ccfmodel/Averaged_younger_fetal_R_label-polarangle_desc-real_roi-v2th00_metric.gii"
    elif group == "3rd":
        average_left = f"/data/p_02915/dhcp_derivatives_SPOT/fetal/ccfmodel/Averaged_older_fetal_L_label-polarangle_desc-real_roi-v2th00_metric.gii"
        average_right = f"/data/p_02915/dhcp_derivatives_SPOT/fetal/ccfmodel/Averaged_older_fetal_R_label-polarangle_desc-real_roi-v2th00_metric.gii"
    elif group == "adolescent":
        average_left = f"/data/p_02915/dhcp_derivatives_SPOT/HCP-D/ccfmodel/Averaged_young_L_label-polarangle_desc-real_roi-v2th00_metric.gii"
        average_right = f"/data/p_02915/dhcp_derivatives_SPOT/HCP-D/ccfmodel/Averaged_young_R_label-polarangle_desc-real_roi-v2th00_metric.gii"
    elif group == "adult":
        average_left = f"/data/p_02915/dhcp_derivatives_SPOT/HCP-D/ccfmodel/Averaged_old_L_label-polarangle_desc-real_roi-v2th00_metric.gii"
        average_right = f"/data/p_02915/dhcp_derivatives_SPOT/HCP-D/ccfmodel/Averaged_old_R_label-polarangle_desc-real_roi-v2th00_metric.gii"
    elif group == "benson":
        template_left = "/data/p_02915/SPOT/01_dataprep/retinotopy/templates_retinotopy/hemi-L_space-fsaverage_dens-164k_desc-angleretinotbenson2014_seg.shape.gii"
        template_right = "/data/p_02915/SPOT/01_dataprep/retinotopy/templates_retinotopy/hemi-R_space-fsaverage_dens-164k_desc-angleretinotbenson2014_seg.shape.gii"
    ...
    plotting.plot_surf_contours(
        ...
        view=(0, 290), axes=ax1, levels=[2, 1, 3], colors=['darkorange', 'k', 'k'],
        linewidths=30  # Thickness of the border line
    )
    plotting.plot_surf_stat_map(
        lh, average_left, bg_map=lh_sulc_map_binary,
    ...
    plotting.plot_surf_contours(
        surf_mesh=lh, roi_map=atlas_data_l, hemi='left',
        view=(-10, -70), axes=ax2, levels=[2, 1, 3], colors=['darkorange', 'k', 'k'],
        linewidths=30  # Thickness of the border line
    )
    plotting.plot_surf_stat_map(
    ...
    plotting.plot_surf_contours(
        ...
        view=(-10, -110), axes=ax3, levels=[2, 1, 3], colors=['darkorange', 'k', 'k'],
        linewidths=30  # Thickness of the border line
    )
    plotting.plot_surf_stat_map(
        rh, average_right, bg_map=rh_sulc_map_binary,
    ...
    plotting.plot_surf_contours(
        surf_mesh=rh, roi_map=atlas_data_r, hemi='right',
        view=(0, 250), axes=ax4, levels=[2, 1, 3], colors=['darkorange', 'k', 'k'],
        linewidths=30  # Thickness of the border line
    )
...
# Save the figure
fig.savefig("/data/p_02915/dhcp_derivatives_SPOT/Figures_v3/PNG_all.png",
