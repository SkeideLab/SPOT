...
for i, group in enumerate(groups):
    ...
    hist_R_pos = [0.61, 1 - i*0.15, 0.12, 0.1]  # Adjusted position for the second histogram
    ...
    fig.text(0.395, 1 - (i * 0.15) + 0.115, text_label[group], ha='center', va='center', fontsize=14)
...
cbar = plt.colorbar(cm.ScalarMappable(cmap='jet', norm=plt.Normalize(vmin=0, vmax=180)), cax=cbar_ax, orientation='horizontal', fraction=.1)
cbar.set_label('Polar angle')

# Save the figure
fig.savefig("/data/p_02915/dhcp_derivatives_SPOT/Figures_v2/PNG_all.png", dpi=300, bbox_inches='tight')
