...
for hemi in left right; do
    ...
    sigma_template="${path_templates_fsaverage}_desc-angleretinotbenson2014_seg.shape.gii"

    # output
    path_out_native_hemi="$path_out_native/sub-${sub}_ses-${ses}_hemi-${hemi_upper}_mesh-native_dens-native"
    sigma_native="${path_out_native_hemi}_desc-angleretinotbenson2014_seg.shape.gii"
