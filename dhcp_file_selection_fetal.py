...
base_folder = '/data/pt_02880/Package_1225541/fmriresults01/dhcp_fmri_pipeline/'

seven_folders = os.listdir(base_folder)

subject_info = pd.DataFrame(columns=["sub_id","scan_age", "sess_id", "func_path", "xfm", "T2w", "wsr", "wsl", "psr", "psl", "msr", "msl", "isr", "isl", "vsr", "vsl", "ssr", "ssl", "mesr", "mesl"])
...
for index, row in enumerate(seven_folders):
    print(row)
    file_name = row
    sess_dir=f"/data/pt_02880/Package_1225541/fmriresults01/dhcp_fmri_pipeline/{file_name}/{file_name}_sessions.tsv"
    ...
    if os.path.isdir(folder_path):
        ...
        if len(sess_ids) > 1:
            for sess_id in sess_ids:
                ...
                file_path_an = "/data/pt_02880/Package_1225541/fmriresults01/dhcp_anat_pipeline/"
