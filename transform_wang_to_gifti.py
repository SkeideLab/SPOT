...
for hemi in ["l", "r"]:
    ##----------------------CHANGE PATHS--------------------------------
    input_wangtemplate = f"/data/u_kieslinger_software/code/neuropythy/neuropythy/lib/data/fsaverage/surf/{hemi}h.wang15_mplbl.v1_0.mgz"
    output_wangtemplate = f"/data/p_02495/templates/template_visualtopography_wang2015/hemi-{hemi.upper()}_space-fsaverage_dens-164k_desc-visualtopographywang2015_label-maxprob_seg.label.gii"
    ##--------------------------------------------------------------------------------
