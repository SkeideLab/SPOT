...
PREFIX_SUB_TEMPLATE = (
    ...
    "{sub}_hemi-{hemi}_mesh-native_dens-32k-native"
)
...
PATH_ECCENTRICITY = "{prefix_sub_template}_desc-eccentretinotbenson2018_seg.shape.gii"
PATH_ANGLE = "{prefix_sub_template}_desc-angleretinotbenson2018_seg.shape.gii"
PATH_VISPARC = (
