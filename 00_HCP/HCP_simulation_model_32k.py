...
Simulated data will have the same local correlation as our resting-state data on V1-V2
...
PREFIX_FUNC = (
    "{derivatives_path}/hcp_surface/{sub}/func/"
    "{sub}_hemi-{hemi}"
)
PATH_SURFPIAL = (
...
PATH_SIMIMG = "{prefix_func}_mesh-native_bold_simulated32.func.gii"
VISPARC_PATH = (
