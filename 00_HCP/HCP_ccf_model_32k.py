...
perform_ccf_analysis = ccfanalysis.ccf_model.ccfprocedures_mp.perform_ccf_analysis
...
VISPARC_PATH = (
    ...
    "{sub}_hemi-{hemi}_mesh-native_dens-32k-native_"
...
DISTANCEFILE_PATH = (
    "{root_dir}/ccfmodel_7T_32k/{sub}/"
    "{sub}_hemi-{hemi}_space-native_desc-V1_dijkstra_32k.npy"
)
FUNC_PATH = (
...
def main():
    ...
    for hemi in ["L", "R"]:
        ...
        for datasource in ["real", "simulated"]:
            ...
            simulated = "_simulated32" if datasource == "simulated" else ""
