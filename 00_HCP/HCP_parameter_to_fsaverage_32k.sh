...
for hemi in L R; do
    ...
    for model in real simulated; do
        for param in r rss sigma v0i; do
            ...
            res_file_native="${path_output_dir}/ccfmodel_7T_32k/${sub}/${sub}_hemi-${hemi}_mesh-native_dens-native_desc-${model}_${param}.gii"
            res_file_fsaverage="${path_output_dir}/ccfmodel_7T_32k/${sub}/${sub}_hemi-${hemi}_mesh-fsaverage_dens-164k_desc-${model}_${param}.gii"
