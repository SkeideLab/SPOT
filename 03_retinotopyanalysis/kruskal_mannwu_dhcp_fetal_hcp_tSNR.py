...
index_label = []
df = pd.DataFrame()
combat_harmonized = pd.read_csv("/data/p_02915/SPOT/raw_tnsr.csv", index_col=None).to_numpy()
...
results_df.to_csv(f'/data/p_02915/SPOT/Result/01_results_tsnr_raw.csv')