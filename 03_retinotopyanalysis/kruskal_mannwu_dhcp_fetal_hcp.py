...
for param in ["_dens-164k_desc-real_rss", "_dens-164k_desc-real_sigma", 
    ...
    for hemi in ["Left", "Right"]:
        if hemi == "Left":            
            groups_flatt = {
                'fetal_y_L': fetal_y_L.flatten(),#[fetal_y_L.flatten() != 0],
                'fetal_o_L': fetal_o_L.flatten(),#[fetal_o_L.flatten() != 0],
                'neonates_y_L': neonates_y_L.flatten(),#[neonates_y_L.flatten() != 0],
                'neonates_o_L': neonates_o_L.flatten(),#[neonates_o_L.flatten() != 0],
            ...
            groups_flatt = {
                'fetal_y_R': fetal_y_R.flatten(),#[fetal_y_R.flatten() != 0],
                'fetal_o_R': fetal_o_R.flatten(),#[fetal_o_R.flatten() != 0],
                'neonates_y_R': neonates_y_R.flatten(),#[neonates_y_R.flatten() != 0],
                'neonates_o_R': neonates_o_R.flatten(),#[neonates_o_R.flatten() != 0],
        ...
        for (groupA_name, groupB_name) in group_pairs:
            ...
            mw_statistic, mw_p_value = mannwhitneyu(groupA_flatt, groupB_flatt, alternative='two-sided')
            ...
            z_score = mann_whitney_u_to_z(mw_statistic, len(groupA_flatt), len(groupB_flatt))
