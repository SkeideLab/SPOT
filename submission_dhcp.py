...
script = "python3 /data/p_02915/SPOT/run_all_sub.py"

#job_id=submit_job([script], mem=600000, cpus=2, log_dir=log_dir, job_name="dhcp_corr")
...
for index in range(0, 126): 
    ...
    job_id = submit_job(
             ...
             mem=60000,
             cpus=2,
             job_name="fetal_2_retinotopy"
             )

#HCP 0-159 /HCD0267242: 146/HCD0185442: 81/HCD0224123: 52 /HCD0338744  46
#sub-CC1176, 305, 1093AN was discarded.
